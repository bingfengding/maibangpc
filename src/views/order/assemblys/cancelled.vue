    ...
    <div id="cancelled">
        ...
        <el-table-column           
            ...
            <template slot-scope="scope">                
                ...
                <div class="goods-money">
                    <p>运费：<span v-if="scope.row.freight>0">+￥{{scope.row.freight}}</span><span v-else>此订单不含运费</span></p>
        ...
        <div class="foot">
            <el-pagination
                ...
                :total="allTypeCount[5]">
            </el-pagination>
            <span>共{{allTypeCount[5]}}条，一页10条</span>            
        </div>            
        <!--确定发货弹窗-->                                   
...
#cancelled >>> .el-table::before{
    height: 0;    
    z-index: 0;
}
#cancelled >>> .el-table--border::after, .el-table--group::after, .el-table::before{
    background-color: #FFF;    
}
#cancelled >>> .el-pagination{
    text-align: center
}
#cancelled >>> .el-table th:nth-child(1){
    padding-left: 20px;
}
#cancelled >>> .el-table th:nth-child(5){
    padding-right: 20px;
    text-align: right;
}
#cancelled >>> .el-input_inner{
    text-align: center!important;
}
#cancelled >>> .el-table_1_column_1 .is-leaf{
    padding-left: 20px;
}
#cancelled >>> .el-button+.el-button{
    margin-left: 0;
}
#cancelled >>> .el-table th{
    background-color: #f2f2f2;    
}
#cancelled >>> .el-table thead {
    color: #333;
    font-size: 14px;    
}
#cancelled >>> .el-table th, .el-table tr{
    background-color: #f8f8f8;
}
#cancelled >>> .el-table .cell{   
    padding: 0;     
}
