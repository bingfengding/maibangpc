    ...
    <div id="refuseRefund">
        ...
        style="min-width: 866px;">
            ...
            min-width="284">
                <template slot-scope="scope">          
                    <div  v-if="scope.row.status==3||scope.row.status==9">               
        ...
        <div class="foot">
            <el-pagination
                ...
                :total="allStatusCount.refuse">
            </el-pagination>
            <span>共{{allStatusCount.refuse}}条，一页10条</span>
        </div>        
        <!-- //员工备注模态框 -->
...
#refuseRefund >>> .el-table th:nth-child(1){
    padding-left: 20px;
}
#refuseRefund >>> .el-table th:nth-child(5){
    padding-right: 20px;
    text-align: right;
}  
#refuseRefund >>> .el-pagination{
    text-align: center;
}
#refuseRefund >>> .el-textarea__inner{
    height: 103px;
}
#refuseRefund >>> .el-message-box__content{
    text-align: center;
}
#refuseRefund >>> .el-message-box{
    text-align: center;
}
#refuseRefund >>> .el-table td, .el-table th{
    padding: 0;
}
#refuseRefund >>> .el-table td, .el-table th.is-leaf{
    border: none;
}
#refuseRefund >>> .el-button{
    margin-left: 0;
}
#refuseRefund >>> .el-table .cell{   
    padding: 0;     
}
#refuseRefund >>> .el-table th, .el-table tr{
