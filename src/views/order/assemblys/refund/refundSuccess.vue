    ...
    <div id="refundSuccess">
        ...
        style="min-width: 866px;">
            ...
            min-width="284">
                <template slot-scope="scope">    
                    <div  v-if="scope.row.status==2||scope.row.status==4||scope.row.status==13">                     
                    <div class="title-info-num" style="font-size: 12px;">服务号：{{scope.row.service_id}}&nbsp;&nbsp;{{scope.row.apply_time}}</div>
                    ...
                    <div class="goods-data">
                        ...
                        <!-- <el-button type="primary" size="mini" style="width:100px;font-size:12px;">还有更多商品</el-button > -->
                    </div>
                </div>
                <el-popover
                    placement="top-start"                                       
            ...
            <el-table-column label="订单金额" min-width="136" >
                <template slot-scope="scope">
                    <div  v-if="scope.row.status==2||scope.row.status==4||scope.row.status==13">
        ...
        <div class="foot">
            <el-pagination
                ...
                :total="allStatusCount.success">
            </el-pagination>
            <span>共{{allStatusCount.success}}条，一页10条</span>
        </div>        
        <!-- //员工备注模态框 -->
...
#refundSuccess >>> .el-table th:nth-child(1){
    padding-left: 20px;
}
#refundSuccess >>> .el-table th:nth-child(5){
    padding-right: 20px;
    text-align: right;
}
#refundSuccess >>> .el-pagination{
    text-align: center;
}
#refundSuccess >>> .el-textarea__inner{
    height: 103px;
}
#refundSuccess >>> .el-message-box__content{
    text-align: center;
}
#refundSuccess >>> .el-message-box{
    text-align: center;
}
#refundSuccess >>> .el-table td, .el-table th{
    padding: 0;
}
#refundSuccess >>> .el-table td, .el-table th.is-leaf{
    border: none;
}
#refundSuccess >>> .el-button{
    margin-left: 0;
}
#refundSuccess >>> .el-table .cell{   
    padding: 0;     
}
#refundSuccess >>> .el-table th, .el-table tr{
