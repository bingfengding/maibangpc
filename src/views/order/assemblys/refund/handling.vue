    ...
    <div id="handling">
        ...
        style="min-width: 866px;">
            ...
            min-width="284">
                <template slot-scope="scope">    
                    <div v-if="scope.row.status==0||scope.row.status==6">                     
                ...
                <el-popover
                    ...
                    <div class="goods-exhibition" slot="reference"  @mousemove="enter(scope.row.products)" @click="goDetail(scope.row.id)">
                        ...
                        <div class="goods-data">
                            ...
                            <p>商品编码：{{scope.row.products[0].product_sku_num}}</p>
                            <p>颜色：{{scope.row.products[0].pro_sku_name}}</p>
        ...
        <div class="foot">
            <el-pagination
                ...
                :total="allStatusCount.applying">
            </el-pagination>
            <span>共{{allStatusCount.applying}}条,一页10条</span>
        </div>        
        <!-- //员工备注模态框 -->
...
#handling >>> .el-table th:nth-child(1){
    padding-left: 20px;
}
#handling >>> .el-table th:nth-child(5){
    padding-right: 20px;
    text-align: right;
} 
#handling >>> .el-pagination{
    text-align: center;
}
#handling >>> .el-textarea__inner{
    height: 103px;
}
#handling >>> .el-message-box__content{
    text-align: center;
}
#handling >>> .el-message-box{
    text-align: center;
}
#handling >>> .el-table td, .el-table th{
    padding: 0;
}
#handling >>> .el-table td, .el-table th.is-leaf{
    border: none;
}
#handling >>> .el-button{
    margin-left: 0;
}
#handling >>> .el-table .cell{   
    padding: 0;     
}
#handling >>> .el-table th, .el-table tr{
