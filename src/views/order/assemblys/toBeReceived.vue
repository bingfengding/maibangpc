       ...
       >        
        ...
        <div class="foot">
            <el-pagination
                ...
                :total="allTypeCount[2]">
            </el-pagination>
            <span>共{{allTypeCount[2]}}条，一页10条</span>            
        </div>            
        <!--确定发货弹窗-->                                   
...
#toBeReceived >>> .el-table::before{
    height: 0;    
    z-index: 0;
}
#toBeReceived >>> .el-table--border::after, .el-table--group::after, .el-table::before{
    background-color: #FFF;    
}
#toBeReceived >>> .el-pagination{
    text-align: center
}
#toBeReceived >>> .el-table th:nth-child(1){
    padding-left: 20px;
}
#toBeReceived >>> .el-table th:nth-child(5){
    padding-right: 20px;
    text-align: right;
}
#toBeReceived >>> .el-input_inner{
    text-align: center!important;
}
#toBeReceived >>> .el-table_1_column_1 .is-leaf{
    padding-left: 20px;
}
#toBeReceived >>> .el-button+.el-button{
    margin-left: 0;
}
#toBeReceived >>> .el-table th{
    background-color: #f2f2f2;    
}
#toBeReceived >>> .el-table thead {
    color: #333;
    font-size: 14px;    
}
#toBeReceived >>> .el-table th, .el-table tr{
    background-color: #f8f8f8;
}
#toBeReceived >>> .el-table .cell{   
    padding: 0;     
}
.title-info{
    width: 100%;
