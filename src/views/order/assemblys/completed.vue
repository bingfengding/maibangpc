    ...
    <div id="completed">
        ...
        <div class="foot">
            <el-pagination
                ...
                :total="allTypeCount[4]">
            </el-pagination>
            <span>共{{allTypeCount[4]}}条，一页10条</span>            
        </div>           
        <!--确定发货弹窗-->                                   
...
#completed >>> .el-table::before{
    height: 0;    
    z-index: 0;
}
#completed >>> .el-table--border::after, .el-table--group::after, .el-table::before{
    background-color: #FFF;    
}
#completed >>> .el-pagination{
    text-align: center
}
#completed >>> .el-table th:nth-child(1){
    padding-left: 20px;
}
#completed >>> .el-table th:nth-child(5){
    padding-right: 20px;
    text-align: right;
}
#completed >>> .el-input_inner{
    text-align: center!important;
}
#completed >>> .el-table_1_column_1 .is-leaf{
    padding-left: 20px;
}
#fullOrder >>> .el-button+.el-button{
    margin-left: 0;
}
#completed >>> .el-table th{
    background-color: #f2f2f2;    
}
#completed >>> .el-table thead {
    color: #333;
    font-size: 14px;    
}
