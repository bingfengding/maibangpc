    ...
    <div id="pendingPayment">
        ...
        <div class="foot">
            <el-pagination
                ...
                :total="allTypeCount[0]">
            </el-pagination>
            <span>共{{allTypeCount[0]}}条，一页10条</span>            
        </div>            
        <!--确定发货弹窗-->                                   
...
<script>
import { MessageBox, Form,Loading} from 'element-ui';
...
#pendingPayment >>> .el-table::before{
    height: 0;    
    z-index: 0;
}
#pendingPayment >>> .el-table--border::after, .el-table--group::after, .el-table::before{
    background-color: #FFF;    
}
#pendingPayment >>> .el-pagination{
    text-align: center
}
#pendingPayment >>> .el-table th:nth-child(1){
    padding-left: 20px;    
}
#pendingPayment >>> .el-table th:nth-child(5){
    padding-right: 20px;
    text-align: right;
}
#pendingPayment >>> .el-input_inner{
    text-align: center!important;
}
#pendingPayment >>> .el-table_1_column_1 .is-leaf{
    padding-left: 20px;
}
#pendingPayment >>> .el-button+.el-button{
    margin-left: 0;
}
#pendingPayment >>> .el-table th{
    background-color: #f2f2f2;    
}
#pendingPayment >>> .el-table thead {
    color: #333;
    font-size: 14px;    
}
#pendingPayment >>> .el-table th, .el-table tr{
    background-color: #f8f8f8;
}
#pendingPayment >>> .el-table .cell{   
    padding: 0;     
}
.title-info{
    width: 100%;
