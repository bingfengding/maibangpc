<template>    
    ...
    <el-table-column      
      ...
      show-overflow-tooltip>
          <template slot-scope="scope" v-if="tableData3">
              <a href="javascript: ;" @click="goUrl(scope.row.product_id,scope.row.sku_id,1)" style="display: inline-block">编辑</a>
          </template>
    </el-table-column>
  </el-table>
...
<style scoped>
#notBeginning >>> .el-table td:nth-child(5){
    text-align: right;         
}
#notBeginning >>> .el-table th:nth-child(5){
    text-align: right;   
    padding-right: 20px;    
}
.wid{
